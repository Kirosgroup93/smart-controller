...
import FactuurPdfModal from "@/components/ui/FactuurPdfModal";
      ...
      <div className="bg-white rounded-xl shadow-sm overflow-hidden">
        ...
        {loading ? (
          ...
          <div className="px-6 py-8 text-center space-y-3">
            ...
            <a href="/api/exact-online/token" className="inline-block text-xs bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700">
              Opnieuw koppelen
            </a>
          </div>
        ) : error ? (
