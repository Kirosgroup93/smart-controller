...
CREATE INDEX idx_exact_connections_user_id ON exact_connections(user_id);
CREATE INDEX idx_financial_snapshots_user_id ON financial_snapshots(user_id);
CREATE INDEX idx_financial_snapshots_type_date ON financial_snapshots(user_id, type, snapshot_date DESC);
